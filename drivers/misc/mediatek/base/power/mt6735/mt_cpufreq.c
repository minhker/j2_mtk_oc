...
#define MIN_VSRAM_VOLT			 (70000)	/* 931.25mv * 100 */
...
/* CPU LEVEL 0, 1.5GHz segment */
static struct mt_cpu_freq_info opp_tbl_e1_0[] = {
	OP(CPU_DVFS_FREQ0, 118125),
	OP(CPU_DVFS_FREQ1, 115000),
	OP(CPU_DVFS_FREQ3, 108750),
	OP(CPU_DVFS_FREQ4, 103125),
	OP(CPU_DVFS_FREQ5, 99375),
	OP(CPU_DVFS_FREQ6, 95000),
	OP(CPU_DVFS_FREQ7, 95000),
	OP(CPU_DVFS_FREQ8, 95000),
};
